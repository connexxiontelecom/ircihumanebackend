...
async function findLeaveAccrualsByLeaveTypeFYyearPositiveExcludeMonth(empId, fyYear, type) {
...
async function getPositiveLeaveAccrualForYearMonthEmployeeLeaveType(year, month, employee_id, leave_type) {
  return await LeaveAccrual.findAll({
    where: {
      lea_emp_id: employee_id,
      lea_fy: year,
