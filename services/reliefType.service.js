...
const ReliefType = require('../models/ReliefType')(
  sequelize,
  Sequelize.DataTypes
);
...
const createReliefType = async (req, res) => {
  try {
    ...
    return res
      .status(201)
      .json({ message: 'Relief type created successfully', data: reliefType });
  } catch (error) {
...
const updateReliefType = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(200)
      .json({ message: 'Relief type updated successfully', data: reliefType });
  } catch (error) {
...
const deleteReliefType = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(200)
      .json({ message: 'Relief type deleted successfully' });
  } catch (error) {
